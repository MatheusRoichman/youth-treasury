...
import { SidebarContainer, SidebarProvider, SidebarToggle } from '@/components/sidebar-container'
        ...
        <div className="flex flex-1 flex-col overflow-y-auto">
          <div className="flex items-center justify-between border-b bg-white px-4 py-3 md:hidden">
            <div className="flex items-center gap-3">
              <Image src="/img/logo.webp" alt="Logo" width={32} height={32} className="h-8 w-8 rounded-lg object-cover" />
              <div>
